...
$order['billing_country_name']  = $db->getOne("SELECT region_name as country_name from " . $GLOBALS['ecs']->table('region') . " WHERE region_id = '$order[billing_country]'");
    ...
    {
        $goods_list[$key]['market_price'] = price_format($value['market_price'], false,true,$order['curr_to'],$order['curr_rate'],$order['curr_format']);
        $goods_list[$key]['goods_price']  = price_format($value['goods_price'], false,true,$order['curr_to'],$order['curr_rate'],$order['curr_format']);
        $goods_list[$key]['subtotal']     = price_format($value['subtotal'], false,true,$order['curr_to'],$order['curr_rate'],$order['curr_format']);
    }
