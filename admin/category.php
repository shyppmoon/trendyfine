...
if ($_REQUEST['act'] == 'insert')
{
	...
	$cat['cat_short_title']     = !empty($_POST['cat_short_title'])     ? $_POST['cat_short_title']           : '';	   //严学文
	$cat['cat_short_desc']     = !empty($_POST['cat_short_desc'])     ? $_POST['cat_short_desc']           : '';
	$cat['cat_short_desc1']     = !empty($_POST['cat_short_desc1'])     ? $_POST['cat_short_desc1']           : '';	//严学文
	$cat['cat_short_desc2']     = !empty($_POST['cat_short_desc2'])     ? $_POST['cat_short_desc2']           : '';
	$cat['cat_short_desc3']     = !empty($_POST['cat_short_desc3'])     ? $_POST['cat_short_desc3']           : '';
...
if ($_REQUEST['act'] == 'update')
{
	...
	$cat['cat_short_title']     = !empty($_POST['cat_short_title'])     ? $_POST['cat_short_title']           : '';
	$cat['cat_short_desc']     = !empty($_POST['cat_short_desc'])     ? $_POST['cat_short_desc']           : '';
	$cat['cat_short_desc1']     = !empty($_POST['cat_short_desc1'])     ? $_POST['cat_short_desc1']           : '';	//严学文
	$cat['cat_short_desc2']     = !empty($_POST['cat_short_desc2'])     ? $_POST['cat_short_desc2']           : '';
	$cat['cat_short_desc3']     = !empty($_POST['cat_short_desc3'])     ? $_POST['cat_short_desc3']           : '';
