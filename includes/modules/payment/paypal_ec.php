...
class paypal_ec
{
    ...
    function get_code($order, $payment)
    {
		...
		$paymentAmount  = price_format($order['order_amount'],false,false,$order['curr_to'],$order['curr_rate'],$order['curr_format']);
		
        $currencyCodeType=$order['curr_to'];;
        $paymentType='Sale';
        ...
        if (isset($resArray["TOKEN"]))
        {
            ...
            $button = '<form name="payform" id="payform" action="'.$payPalURL. '" value="' .$GLOBALS['_LANG']['paypal_button']. '"/></form>';
