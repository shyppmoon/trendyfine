...
class cappay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $def_url .= "<input type= 'hidden' name = 'v_mid'     value= '".$v_rcvname."'>";     //商户編號
        ...
        $def_url .= "<input type= 'hidden' name = 'v_amount'   value= '".$v_amount."'>";     //訂單总金额
        $def_url .= "<input type= 'hidden' name = 'v_ymd'      value= '".$v_ymd."'>";        //訂單产生日期
        ...
        $def_url .= "<input type='hidden' name='v_md5info' value=$result>";              //訂單数字指纹
        ...
        $def_url .= "<input type='hidden' name='v_moneytype' value='".$v_moneytype."'>";   //币种,0为人民币,1为美元
        $def_url .= "<input type='hidden' name='v_url' value='".$v_url."'>";              //支付动作完成后返回到该url，支付结果以GET方式发送
        $def_url .= "<input type='hidden' name='v_md5info' value=$result[0]>";           //訂單数字指纹
