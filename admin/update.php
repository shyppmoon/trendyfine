...
//图片水印 
$waterImage="";//水印图片路径  $waterImage="../images/watermark.png";
//---------------------------------------------------------------------------------------------
   ...
   // echo "临时文件: " . $_FILES["Filedata"]["tmp_name"] . "<br />";
    ...
    if (file_exists( $_FILES["Filedata"]["name"]))
    {
    ...
    else
      {
		...
		$ifilename="P_".date('YmdHis')."_".rand(10,99).$type;
		...
		$ic->SaveImage();  
	 	...
	 	// echo "MD5效验:".getGet("access2008_File_md5")."<br />";
	  	echo "<li><img src='../".preg_replace("/..\//","",$attachdir_G.$ifilename,1)."' width=150 height=150/><input type=\"hidden\" name=\"img_url[]\"  value=\"".preg_replace("/..\//","",$attachdir_G.$ifilename,1)."\" size=\"20\" /><input type=\"hidden\" name=\"img_original[]\"  value=\"".preg_replace("/..\//","",$attachdir_S.$ifilename,1)."\" size=\"20\" /><input type=\"hidden\" name=\"thumb_url[]\"  value=\"".preg_replace("/..\//","",$attachdir_T.$ifilename,1)."\" size=\"20\" /><input type=\"hidden\" name=\"temp_name[]\"  value=\"".$_FILES["Filedata"]["name"]."\" size=\"20\" /></li>";
