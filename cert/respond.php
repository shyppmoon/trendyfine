...
//严学文--把几个参量赋值给前端
$tf_order_amount = $_GET["amt"];	  //获取订单金额
$tf_curr_to = $_GET["tf_curr_to"];
$tf_order_sn =  $_GET["tf_order_sn"];
$smarty->assign('tf_order_amount', $tf_order_amount);   // 订单金额
$smarty->assign('tf_curr_to', $tf_curr_to);   //  支付币种
$smarty->assign('tf_order_sn', $tf_order_sn);   //	订单编号
