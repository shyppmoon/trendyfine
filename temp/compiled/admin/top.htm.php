...
<div id="header-div">
  ...
  <div id="submenu-div">
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
      ...
      <?php endif; ?>
	  <a href="index.php?act=piliang_gai_jiage" target="main-frame" class="fix-submenu">批量改价格</a>
	  <a href="index.php?act=copy_goods_wi" target="main-frame" class="fix-submenu">批量导数据</a>
