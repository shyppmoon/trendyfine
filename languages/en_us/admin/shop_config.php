...
$_LANG['cfg_name']['currency_format'] = '默认货币格式';
$_LANG['cfg_name']['currency_to'] = '默认货币代码';
$_LANG['cfg_name']['currency_name'] = '默认货币名称';
$_LANG['cfg_name']['currency_icon'] = '默认货币图标';
/*--wzys多国货币end--*/
...
$_LANG['cfg_name']['is_send_reg'] = '会员注册成功是否发送邮件';
$_LANG['cfg_range']['is_send_reg']['0'] = '否';
$_LANG['cfg_range']['is_send_reg']['1'] = '是';

$_LANG['cfg_name']['is_pay_reminded_costome'] = '付款成功是否给客户发送邮件';
$_LANG['cfg_range']['is_pay_reminded_costome']['0'] = '否';
$_LANG['cfg_range']['is_pay_reminded_costome']['1'] = '是';

$_LANG['cfg_name']['is_pay_reminded_service'] = '付款成功是否给商家发送邮件';
$_LANG['cfg_range']['is_pay_reminded_service']['0'] = '否';
$_LANG['cfg_range']['is_pay_reminded_service']['1'] = '是';

$_LANG['cfg_name']['is_order_reminded_costome'] = '下单成功是否给客户发送邮件';
$_LANG['cfg_range']['is_order_reminded_costome']['0'] = '否';
$_LANG['cfg_range']['is_order_reminded_costome']['1'] = '是';
