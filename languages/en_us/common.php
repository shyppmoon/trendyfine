...
$_LANG['cart_info'] = "<span style='text-decoration: none;color: #fff;font-size: 11px;line-height: 36px;padding-left:38px;' class='char_logo' ><span> (<b>%d</b>)";
...
$_LANG['goods_bonus'] = 'Coupon for buying:';
