...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['configure'] = array(
                                    array('name' => 'item_fee',     'value'=>15), /* 单件產品的配送费用 */
                                    array('name' => 'base_fee',    'value'=>15), /* 1000克以内的價格           */
                                    array('name' => 'step_fee',     'value'=>5),  /* 续重每1000克增加的價格 */
                                );
...
class sto_express
{
     ...
     * @param   float   $goods_amount   產品金额
     * @param   float   $goods_amount   產品件数
     * @return  decimal
     */
